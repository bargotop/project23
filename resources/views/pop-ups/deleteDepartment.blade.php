<div id="deleteDepartment" class="hidden fixed inset-0 z-10">
    <div class="text-center bg-white rounded-lg shadow m-4 p-4">
        ...
        <div class="text-[14px] flex space-x-3 mt-5">
            <button class="w-full rounded-lg py-2 text-white bg-red-500 hover:bg-red-600 active:bg-red-700 deleteDepartmentConfirmBtn" data-modal-toggle="deleteDepartment">Да</button>
            <button class="w-full rounded-lg py-2 bg-gray-100 hover:bg-gray-200 active:bg-gray-300" data-modal-toggle="deleteDepartment">Нет</button>
        </div>
    </div>
</div>