<div id="deleteStudent" class="hidden fixed inset-0 z-10">
    <div class="text-center bg-white rounded shadow m-4 p-4">
        ...
        <div class="text-[14px] flex space-x-3 mt-5">
            <button class="w-full rounded py-2 text-white bg-red-500 hover:bg-red-600 active:bg-red-700 deleteStudentConfirmBtn" data-modal-toggle="deleteStudent">Да</button>
            <button class="w-full rounded py-2 bg-gray-100 hover:bg-gray-200 active:bg-gray-300" data-modal-toggle="deleteStudent">Нет</button>
        </div>
    </div>
</div>