        ...
        <div class="pt-5 pb-10">
            @foreach ($group->subjects as $subject)
                <div class="flex justify-between bg-white overflow-hidden shadow-sm sm:rounded-lg mt-5 p-5 subject">
                    ...
                    <img class="cursor-pointer ms-2 deleteSubjectBtn" src="/img/delete.svg" data-modal-toggle="deleteSubject" data-id="{{ $subject->id }}" data-delete-url="{{ route('subjects.delete', ['subjectId' => $subject->id]) }}">
                </div>
            @endforeach
        </div>
